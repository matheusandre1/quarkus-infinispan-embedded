...
a|icon:lock[title=Fixed at build time] [[quarkus-infinispan-embedded_quarkus-infinispan-embedded-health-enabled]] [.property-path]##link:#quarkus-infinispan-embedded_quarkus-infinispan-embedded-health-enabled[`+++quarkus.infinispan-embedded.health-enabled+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.infinispan-embedded.health-enabled+++[]
...
Environment variable: env_var_with_copy_button:+++QUARKUS_INFINISPAN_EMBEDDED_HEALTH_ENABLED+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_INFINISPAN_EMBEDDED_HEALTH_ENABLED+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`
